    ...
    return (
        <div className="flex flex-col mb-10">
            <div className={"flex flex-col items-center"}>
                ...
                <p className={"w-1/2 sm:text-[18px] text-[16px] font-thin font-montserrat my-4"}>
                ...
                <div className={"grid grid-cols-2 gap-x-10"}>
                    <div className={"flex flex-col items-center"}>
                        <p className={"sm:text-[20px] text-[16px] font-montserrat mt-6 mb-1"}>Venmo: @Mahyar-Babaie</p>
                        <img src={`${mahyarVenmoImg}`} alt={"mahyar venmo qr code"}
                             className={"object-cover h-[400px] w-[300px] rounded-lg"}/>
                    </div>
                    <div className={"flex flex-col items-center"}>
                        <p className={"sm:text-[20px] text-[14px] font-montserrat mt-6 mb-1"}>Venmo: @Shima-dn</p>
